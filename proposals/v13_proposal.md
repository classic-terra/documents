### Release v3.5.0
A new release of the `terrad` client has been created on 29 Sep 2025 . The release notes for the new version can be viewed here:
https://github.com/classic-terra/core/releases/tag/v3.6.0-rc.0
...
This proposal seeks validator and community approval to update the `terrad` client to `v3.6.0-rc.0` (upgrade name `v13`). The chain will be halted at 25619230 which will approximately be processed on Oct 20, 2025 2:00PM UTC. The actual halt time is an early estimate, can vary and depends on the chain's block speed until the specified height is reached. Upon passing of this proposal, an automatic chain halt will be scheduled at the specified height. The validators are going to be asked to install the new version of the `terrad` client after the chain halt occured. 
...
```bash
$ git clone https://github.com/classic-terra/core core-v3.6.0-rc.0
$ cd core-v3.6.0-rc.0
$ git checkout v3.6.0-rc.0
...
- **YES** - you agree to schedule an upgrade to v3.6.0-rc.0
- **NO** - you don't agree to schedule an upgrade to v3.6.0-rc.0
